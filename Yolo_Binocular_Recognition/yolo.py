...
left_camera_matrix = np.array(
    [[508.5608, 0, 311.6384], [0, 507.8389, 249.3377], [0, 0, 1]]
)
right_camera_matrix = np.array(
    [[508.4076, 0, 312.6734], [0, 507.2450, 252.4405], [0, 0, 1]]
)
left_distortion = np.array([[0.2281, -0.2123, 0.0075, -0.0104, 0]])
right_distortion = np.array([[0.2386,-0.2293, 0.0071, -0.0099, 0]])
R = np.array(
    [
        [0.9999, -0.0003, 0.0109],
        [0.0003, 1.0000, 0.0018],
        [-0.0109, -0.0018, 0.9999],
    ]
)
T = np.array([[63.6951], [-0.0758], [-0.8247]])
size = (640, 480)
